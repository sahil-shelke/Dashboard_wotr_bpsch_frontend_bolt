                ...
                <table className="w-full border border-gray-200 text-xs">
                  <thead>
                    <tr className="bg-gray-100">
                      ...
                      <th className="px-3 py-2 text-right border-b border-gray-200 font-semibold">S1 Dry (gm)</th>
                      <th className="px-3 py-2 text-right border-b border-gray-200 font-semibold">S1 Wet (gm)</th>
                      <th className="px-3 py-2 text-right border-b border-gray-200 font-semibold bg-blue-50">S1 %</th>
                      <th className="px-3 py-2 text-right border-b border-gray-200 font-semibold">S2 Dry (gm)</th>
                      <th className="px-3 py-2 text-right border-b border-gray-200 font-semibold">S2 Wet (gm)</th>
