...
function WeatherForecast() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      {isOpen ? (
        <div className="bg-white rounded-2xl shadow-2xl w-80 max-h-[500px] overflow-hidden border border-gray-200">
                  ...
                  <div className="p-4 bg-blue-50">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex items-start gap-2">
                        <CloudRain className="w-4 h-4 text-blue-600 mt-1" />
                        <div>
        ...
        <button
          ...
          className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all hover:scale-105"
        >
